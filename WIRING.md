...
I try to describe how I wired everything together the best I can...

The plug connectors have been used as follows:
...
Stereo plug (GND, Ring, Tip): yarn sensor

If you, for any reason, change the pin assignment to the Arduino, you will have to change the pin assignments in HardwareConfig.h, too, before flashing.
...
- 5V:  Arduino 5V (you have to make sure, that your Arduino DOES deliver 5V, not 4.98V or something - !IMPORTANT!)
- GREEN: D2
- WHITE: D3


GND connection summary
-----------------------
